...
<ul>
<li>[RideOn](https://mobile.psu.edu/project/ride-on/) is a ride-matching app from PSU. [TODO: Does anyone actually use it for this?]</li>
...
<li>The enterprising traveler could walk from the airport (in non-CATA Benner Township) about a mile across the Patton Township line, to a point on Fox Hill Rd slightly west of the intersection with Fillmore Rd.  He would then be in the Centre Area North zone in the new Extended CATAGO service, and eligible for a ride into an area served by regular CATA buses, probably either Medlar Field or Hills Plaza.  This requires booking a day ahead. (I haven't done this yet, please send a report if you are successful.)
</li>
</ul>
